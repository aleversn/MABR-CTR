...
class Config:
	...
	max_cnt_line_items=150

	train_ratio=0.7
	#folder_base = '/home/cwt/WSDM2020_HUP-master/HUP_Data/'
	folder_base = '/home/cwt/project/data/'
	#670: JD_Computers,  737:JD_Applicances
	data_source_name=['Computers', 'Applicances', 'UserBehavior']
	...
	if(data_source == "Computers"):
		...
		# file_data_raw = 'JD_Computers_sample'
		...
		# file_data_src = "JD_Computers.topsku.len5"
		train_ratio = 0.7
		min_cnt_line_items = 30
		seq_len_min = 30
		seq_len_max = 30
		# min_cnt_line_items = 5
	...
	if (data_source == "Applicances"):
		...
		file_data_src = 'JD_Applicances.topsku.len40_150'
		train_ratio = 0.7
		min_cnt_line_items = 40
		seq_len_min = 40
		seq_len_max = 150
	...
	if (data_source == "UserBehavior"):
		folder_data = 'UserBehavior'
		file_data_raw = 'UserBehavior'
		min_cnt_sku_limit = 10
		file_data_raw_topsku = 'UserBehavior.topsku'
		file_data_raw_topsku_len = 'UserBehavior.topsku.len'
		train_ratio = 0.7
		min_cnt_line_items = 40
		max_cnt_line_items = -1
		file_data_src = "JD_Computers.topsku.len" + str(min_cnt_line_items)
		seq_len_min = 40
		seq_len_max = -1
