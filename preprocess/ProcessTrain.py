...
class ProcessTrain():
    ...
    def get_map_sku_cid3_id(cls, file_sku_cid3, file_sku, file_cid3, file_skuId_cid3Id):
        ...
        i=0
        for (skuStr,cid3Str) in list(map_skuStr_cid3Str.items()):
